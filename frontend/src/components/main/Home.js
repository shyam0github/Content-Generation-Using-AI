        ...
        >
          <section className="mb-10">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://images.squarespace-cdn.com/content/v1/57462f541bbee075320514a9/1624462944359-1UDIFWK5V8FZATQNKVXY/shutterstock_403937386.jpg")',
                height: '70vh',
              ...
              >
                <div className="card-body px-4 py-5 px-md-5">
                  <h1 className="display-3 fw-bold ls-tight mb-4">
                    <span className="text-white">AI Content Generator</span> <br />
                    <span className="" style={{color : '#8839da'}}>for Everyone</span>
                  </h1>
                  <Link
